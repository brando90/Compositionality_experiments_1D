...
plot(ux,uy,'Marker','o','LineWidth',3,'Color',colr);%ylim([1.5 2.5]);
...
% %fx1 = polyval(p,x1);
% fx2 = f2(x1); 
% [fx2 x1] = nonparametric_fit_by_binning_overlap(x,y,0.4,0.01); plot(x1,fx2,'Marker','o','LineWidth',3,'Color',colr);
...
% %plot(x1,fx2,'Marker','o','LineWidth',3,'Color',colr);
