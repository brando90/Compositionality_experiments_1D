...
%function_name  = 'binary tree, |left - right|+';
function_name  = 'Function suggested by Mhaskar';
%function_name  = 'binary tree, |left - right|';
%function_name  = 'binary tree, cosine';
...
plot(ux,uy,'LineWidth',3,'Color','b');%ylim([1.5 2.5]);
% colr = 'k';
...
plot(ux,uy,'LineWidth',3,'Color','r');
