...
for i = 1:numel(candidates)
    for r = 1:3
        numEpochs = 400; enable_residual = false; first_layer_func = @return_1st_arg; disable_bias = false; all_t=tic; lr = 0.0005; nVar = 1; nOrder = 2; rprop_p = 0; hiddenLayers = [candidates(i) ]; force_batchSize = 3000; useBatchNorm = true; poly_eval_func = @poly_eval_n1_sin2; nonlinearity = struct('type','relu');
        % if candidates(i) > 64
