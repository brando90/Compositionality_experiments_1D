function [ imdb ] = make_1D_data_matconvnet_format( N_train, N_test, X_train, Y_train, X_test, Y_test )
%
...
%%
imdb = struct();
imdb.images.data = zeros(1,1,1,N);
imdb.images.label = zeros(1,1,1,N);
